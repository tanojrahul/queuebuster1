...
# Import additional modules for admin functionalities
...
def login_view(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            if is_admin:  # Redirect admin users to the admin dashboard
...
def scan_product_view(request):
    if request.method == 'POST':
        ...
        try:
            ...
            # Success response, the product exists
